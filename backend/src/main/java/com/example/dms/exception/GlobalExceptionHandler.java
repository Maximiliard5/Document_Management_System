...
public class GlobalExceptionHandler {
    ...
    //Thrown manually by service-layer ownership/membership checks (checkOwner/checkMemberOrOwner
    //in Project/Task/DocumentService). AuthorizationDeniedException (handled above) extends this
    //class but is only thrown by @PreAuthorize; without this handler these fell through to the
    //generic Exception handler and returned 500 instead of 403.
